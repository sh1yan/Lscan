...
func Flag(addre *lc.HostInfo, instruct *lc.CommandInfo) {
	...
	flag.StringVar(&instruct.Modular, "m", "", "Select scan modular: survival | portscan | ftp | ssh | find-net | snmp | smb | ms17010 | smbghost | rmi | mssql | oracle | zookeeper | docker | mysql | rdp | postgres | redis | k8s | elastic | memcached | mongodb")
	...
	flag.Int64Var(&lc.WebTimeout, "wt", 5, "Set web timeout")
